...
def check_collision(pipes):
    ...
    if bird_rect.top <= -5 or bird_rect.bottom >= 998:
        return False
...
game_font = pygame.font.Font("assets/arial.ttf", 40)
...
bird_midflap = pygame.transform.scale2x(pygame.image.load('assets/yellowbird-downflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('assets/yellowbird-downflap.png').convert_alpha())
